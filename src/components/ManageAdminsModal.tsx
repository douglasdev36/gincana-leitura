    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-6 animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {success && (
            <div className="bg-emerald-50 text-emerald-700 p-3 rounded-md text-sm text-center border border-emerald-200">
              {success}
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full mt-6 bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-2.5 px-4 rounded-md transition-colors disabled:bg-emerald-400"
          >
